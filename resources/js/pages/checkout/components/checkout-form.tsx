...
import { Truck,ChevronRight,CreditCard ,Lock,ClipboardCheck} from 'lucide-react'
import { Label } from '@/components/ui/label'
import { Input } from '@/components/ui/input'
import { Button } from '@/components/ui/button'
import { useTranslation } from 'react-i18next'
export default function CheckoutForm({ step,setStep,setPayMethod,payMethod,setPlaced}: any) {
