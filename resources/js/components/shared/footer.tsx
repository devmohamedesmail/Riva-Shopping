                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="space-y-2.5 text-sm">
                            ...
                            <div className="flex items-start gap-2.5">
                                <MapPin
                                    size={15}
                                    className="text-[#c96] shrink-0 mt-0.5"
                                />
                            ...
                            <div className="flex items-center gap-2.5">
                                ...
                                <a
                                    href="mailto:support@shopella.com"
                                    className="text-gray-400 hover:text-white transition-colors"
                                >
                                    support@shopella.com
                                </a>
                            </div>
                        </div>
                    </div>
                                ...
                                {links.map((link) => (
                                    <li key={link}>
                                        ...
                                        >
                                            <ChevronRight
                                                size={12}
                                                className="opacity-0 group-hover:opacity-100 -ml-2 group-hover:ml-0 transition-all text-[#c96]"
                                            />
            ...
            <div className="border-t border-white/10">
                <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <p className="text-xs text-gray-500 flex items-center gap-1">
                        © {new Date().getFullYear()} Shopella.

                        {t('footer.madeWith')}

                        <Heart
                            size={11}
                            className="text-red-500 fill-red-500 mx-0.5"
                        />
